...
{
System.ut.println("You should have at least " + MIN_PLAYERS + " but no more than " + MAX_PLAYERS + " per team.");
System.out.print("Enter the number of players per team: ");
teamSize= keyboard.nextInt();
}
...
System.out.println("There will be " + teams + " teams with " + leftOver + " players left.");
}
}